...
namespace NetworksLab2CSharp
{
    class SenderClassScenario3
    {
        ...
        public void SendData(Socket sock)
        {
            ...
            //        {
            //            System.Windows.Forms.MessageBox.Show(se.Message + "i value: " + i.ToString());
            //        }
            ...
            //string path1 = @"c:\Logs\Lab2.Scenario2.WurdingerO.txt";
            //StreamWriter logWrite1 = File.AppendText(path1);

            //string date = System.DateTime.Now.ToString("MMddyyyy");
            //string time = System.DateTime.Now.ToString("HHmmss");

            //logWrite1.Write(date + "|" + time + "|0|0|");
